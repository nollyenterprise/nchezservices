...
import { Mail, Phone, MapPin, ArrowRight, CheckCircle2, AlertCircle, ChevronDown, Send } from 'lucide-react';
...
export const ContactPage: React.FC<ContactPageProps> = () => {
  ...
  const directMailtoUrl = `mailto:${COMPANY_INFO.email}?subject=${encodeURIComponent(
    `Project Enquiry from ${fullName || 'Client'} [${serviceInterest || 'General'}]`
  ...
  return (
    <div 
      id="contact-page" 
      className="min-h-screen bg-[#0F0F11] text-white pt-24 sm:pt-32 lg:pt-36 pb-20 sm:pb-28"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        <div className="max-w-3xl mb-12 sm:mb-16">
          ...
          <motion.p 
            className="mt-4 text-sm sm:text-base lg:text-lg text-gray-300 leading-relaxed font-normal"
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.55, delay: 0.35 }}
          >
            Tell us about your requirements. Our engineering and commercial team will review your specifications and respond promptly with a technical consultation or quotation.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div 
              id="contact-office-card"
              className="p-5 sm:p-6 rounded-xl bg-[#18181B] border border-white/10 shadow-md"
            >
              <div className="flex items-start gap-4">
          ...
          <div className="lg:col-span-7 w-full">
            ...
            {status === 'success' ? (
              <div id="contact-success-state" className="bg-[#18181B] border border-white/15 p-6 sm:p-10 rounded-2xl text-center space-y-6 animate-in fade-in duration-300 shadow-2xl">
                ...
                <div className="max-w-md mx-auto space-y-2">
                  ...
                  <p className="text-sm text-gray-300">
                    Thank you for contacting Nchez Services Limited. Your project enquiry has been registered and routed to our technical engineering desk.
                  </p>
                </div>
              ...
              <form 
                ...
                className="bg-[#18181B] p-6 sm:p-8 lg:p-10 rounded-2xl border border-white/10 shadow-2xl space-y-6"
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="contact-full-name" className="block text-xs font-bold uppercase tracking-wider text-gray-300">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="contact-email-input" className="block text-xs font-bold uppercase tracking-wider text-gray-300">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="contact-company-input" className="block text-xs font-bold uppercase tracking-wider text-gray-300">
                      Company (Optional)
                    </label>
                    <input
                  ...
                  <div className="space-y-2">
                    <label htmlFor="contact-service-select" className="block text-xs font-bold uppercase tracking-wider text-gray-300">
                      Service of Interest
                    </label>
                    <div className="relative">
                      ...
                      >
                        ...
                        {SERVICES.map((srv) => (
                          <option key={srv.id} value={srv.title} className="bg-[#0F0F11] text-white">
                            {srv.title}
                          </option>
                        ))}
                        <option value="General Engineering & Support" className="bg-[#0F0F11] text-white">
                          General Engineering &amp; Industrial Support
                        </option>
                      </select>
                ...
                <div className="space-y-2">
                  <label htmlFor="contact-details-input" className="block text-xs font-bold uppercase tracking-wider text-gray-300">
